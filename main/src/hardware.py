...
def init_pid(pid: rev.SparkClosedLoopController, pid_config: PIDConfig, feedback_device: rev.SparkMax | None = None):
...
def read_pid(pid: rev.SparkClosedLoopController) -> PIDConfig:
    """Configures a SparkMax PID controller with the provided PIDConfig"""
...
def adjust_pid(pid: rev.SparkClosedLoopController, pid_config: PIDConfig):
    """Configures a SparkMax PID controller with the provided PIDConfig"""
    safe_set_rev_in_thread(pid.setP, pid_config.p)
    safe_set_rev_in_thread(pid.setI, pid_config.i)
    safe_set_rev_in_thread(pid.setD, pid_config.d)
